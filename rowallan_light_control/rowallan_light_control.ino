...
SensorI2C sensor14(&relayI2CBoard1, 4); // Dining
SensorI2C sensor21(&relayI2CBoard2, 1); // Covered
SensorI2C sensor22(&relayI2CBoard2, 2); // Trough
SensorI2C sensor23(&relayI2CBoard2, 3); // BBQ Area
// SensorI2C sensor24(&relayI2CBoard2, 4); // Unused
SensorGPIO sensorD7(7);          // Day night detector
SensorI2CKeypad sensorKeypad(8); // Kitchen Door Keypad
...
LightI2C light14(&relayI2CBoard1, 3); // Dining
...
LightI2C light24(&relayI2CBoard2, 3); // Kitchen Door Release
...
TimerModeAware timer3(600000ul, 600000ul, 600000ul, 0);            // Kitchen Spot
...
TimerModeAware timer6(600000ul, 600000ul, 600000ul, 0);            // Trough
...
Circuit circuit4(&sensor14, &light14, &timer4, Circuit::MODE_TOGGLE, 2000); // Dining
Circuit circuit5(&sensor21, &light21, &timer5, Circuit::MODE_TOGGLE, 2000); // Covered
